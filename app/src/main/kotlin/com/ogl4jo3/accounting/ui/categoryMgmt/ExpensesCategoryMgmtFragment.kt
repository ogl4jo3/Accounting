...
class ExpensesCategoryMgmtFragment : Fragment() {
    // UI元件
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_category_mgmt_expenses, container, false)
    ...
    override fun onOptionsItemSelected(item: MenuItem): Boolean {
        ...
        if (id == R.id.menu_hint) {
            Toast.makeText(
                activity, getString(R.string.hint_category_mgmt),
                Toast.LENGTH_SHORT
            ).show()
        }
    ...
    private fun initCategoryList() {
        ...
        categoryList = CategoryDAO(db).allExpensesCategories
    ...
    private fun initUI(view: View) {
        ...
        mRecyclerView = view.findViewById<View>(R.id.rv_expenses_category) as RecyclerView
    }
    ...
    private fun setRecyclerView() {
        ...
        // Adapter
        mAdapter = ExpensesCategoryAdapter(requireContext(), requireFragmentManager(), categoryList)
        ...
        val mItemTouchHelper = ItemTouchHelper(
            object : ItemTouchHelper.SimpleCallback(ItemTouchHelper.UP or ItemTouchHelper.DOWN, 0) {
                ...
                override fun onMove(
                    ...
                    (mAdapter as ExpensesCategoryAdapter).onItemMove(
