...
class ExpenseCategoryAdapter(val viewModel: ExpenseCategoryMgmtViewModel) :
        ...
        holder.binding.apply {
            ...
            swipeLayoutCategory.surfaceView.setOnClickListener {
                Navigation.findNavController(holder.itemView).navigate(
                    ExpenseCategoryMgmtFragmentDirections.actionExpenseCategoryMgmtFragmentToExpensesCategoryEditFragment(
                        category
                    )
                )
            }
