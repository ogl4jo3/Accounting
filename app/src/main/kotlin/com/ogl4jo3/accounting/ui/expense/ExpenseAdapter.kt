...
//            val expensesNewEditFragment = ExpensesNewEditFragment.newInstance(expenses.recordTime, Gson().toJson(expenses))
...
//                    .addToBackStack(null).commit()
            ...
            Navigation.findNavController(holder.itemView).navigate(ExpenseFragmentDirections
                    .actionExpenseFragmentToExpenseNemEditFragment(
                            mContext.getString(R.string.title_expenses_edit),
                            expenses.recordTime,
