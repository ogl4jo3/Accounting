...
class ExpensesCategoryNewEditFragment : Fragment() {

    private val args: ExpensesCategoryNewEditFragmentArgs by navArgs()
    ...
    private fun setOnClickListener() {
        btnSave!!.setOnClickListener(View.OnClickListener {
            ...
            if (categoryName.isEmpty()) {
                ...
                return@OnClickListener
                    ...
                    .checkExpensesRepeated(categoryName, categoryIcon, categoryID)
            ) { //檢查是否重複
                Toast.makeText(
                    activity, getString(
            ...
            if (args.categoryJsonStr.isNullOrEmpty()) {
                CategoryDAO(db).newExpensesData(categoryNew)
            } else {
                categoryNew.id = category!!.id
                categoryNew.orderNum = category!!.orderNum
                CategoryDAO(db).saveExpensesData(categoryNew)
            }
        ...
        btnDel!!.setOnClickListener { //刪除
            ...
            builder.setPositiveButton(
                ...
                val db = MyDBHelper.getDatabase(activity)
                CategoryDAO(db).deleteExpensesData(category)
                Toast.makeText(
                    activity, getString(
