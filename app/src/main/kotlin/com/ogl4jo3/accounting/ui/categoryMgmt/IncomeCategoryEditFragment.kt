...
class IncomeCategoryEditFragment : BaseFragment() {
    ...
    override fun onCreateView(
        ...
        return binding.apply {
            viewModel = this@IncomeCategoryEditFragment.viewModel
            lifecycleOwner = viewLifecycleOwner
            rvCategories.layoutManager = GridLayoutManager(context, 5)
            categoryIconList = this@IncomeCategoryEditFragment.categoryIconList
        }.root
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.apply {
            rvCategories.adapter = CategoryIconAdapter { categoryIcon ->
                this@IncomeCategoryEditFragment.viewModel.selectCategoryIcon(categoryIcon)
            }
        ...
        viewModel.apply {
            ...
            navToCategoryMgmtFragment = {
                findNavController().navigate(
                    IncomeCategoryEditFragmentDirections
                        .actionIncomeCategoryEditFragmentToIncomeCategoryMgmtFragment()
                )
            }
        }
    }
