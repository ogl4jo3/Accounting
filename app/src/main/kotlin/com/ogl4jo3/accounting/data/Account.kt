...
data class Account(
        ...
        @ColumnInfo(name = "budgetPrice") var budgetPrice: Int, //預算金額
        @ColumnInfo(name = "budgetNotice") var budgetNotice: Float, //預算低於多少百分比提醒
        @ColumnInfo(name = "balance") var balance: Int, //帳戶餘額
)
