...
public class AccountBudgetingAdapter
	...
	public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
		...
		View view = LayoutInflater.from(parent.getContext())
				.inflate(ogl4jo3.shaowei.ogl4jo3.accounting.R.layout.item_account_budgeting, parent, false);
		...
		holder.itemView.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				fragmentManager.beginTransaction()
						.replace(ogl4jo3.shaowei.ogl4jo3.accounting.R.id.layout_main_content, budgetEditFragment, null)
	...
	static class ViewHolder extends RecyclerView.ViewHolder {
		...
		public ViewHolder(View itemView) {
			...
			ivAccountCategoryIcon =
					(ImageView) itemView.findViewById(ogl4jo3.shaowei.ogl4jo3.accounting.R.id.iv_account_category_icon);
			tvAccountName = (TextView) itemView.findViewById(ogl4jo3.shaowei.ogl4jo3.accounting.R.id.tv_account_name);
			tvRemainingBudget = (TextView) itemView.findViewById(
					ogl4jo3.shaowei.ogl4jo3.accounting.R.id.tv_remaining_budget);
			tvBudget = (TextView) itemView.findViewById(ogl4jo3.shaowei.ogl4jo3.accounting.R.id.tv_budget);
		}
	}
}
