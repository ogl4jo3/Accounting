package ogl4jo3.shaowei.ogl4jo3.accounting.setting.categorymanagement.income;
...
import ogl4jo3.shaowei.ogl4jo3.accounting.setting.categorymanagement.CategoryAdapter;
 ...
 * Use the {@link IncomeCategoryMgmtFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class IncomeCategoryMgmtFragment extends Fragment {

	public static final String INCOME_CATEGORY_MGMT_FRAGMENT_TAG =
			"INCOME_CATEGORY_MGMT_FRAGMENT_TAG";
	...
	public IncomeCategoryMgmtFragment() {
	 ...
	 * @return A new instance of fragment IncomeCategoryMgmtFragment.
	 */
	// TODO: Rename and change types and number of parameters
	public static IncomeCategoryMgmtFragment newInstance(String param1, String param2) {
		IncomeCategoryMgmtFragment fragment = new IncomeCategoryMgmtFragment();
	...
	public boolean onOptionsItemSelected(MenuItem item) {
		...
		if (id == R.id.menu_hint) {
			Toast.makeText(getActivity(), getString(R.string.hint_category_mgmt), Toast.LENGTH_SHORT).show();
	...
	private void initUI(View view) {
		...
		mRecyclerView = (RecyclerView) view.findViewById(R.id.rv_income_category);
	}
	...
	private void setRecyclerView() {
		...
		// Adapter
		mAdapter = new IncomeCategoryAdapter(getActivity(), getFragmentManager(), categoryList);
		...
		btnNew.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View view) {
				...
				IncomeCategoryNewEditFragment incomeCategoryNewEditFragment =
						IncomeCategoryNewEditFragment.newInstance("new", "");
