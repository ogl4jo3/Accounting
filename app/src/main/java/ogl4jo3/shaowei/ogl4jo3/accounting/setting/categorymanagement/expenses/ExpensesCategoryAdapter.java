...
public class ExpensesCategoryAdapter extends CategoryAdapter {

	private Context mContext;
	private FragmentManager fragmentManager;
	private List<Category> categoryList;

	public ExpensesCategoryAdapter(Context context, FragmentManager fragmentManager,
	...
	public void onItemClick(int position) {
		...
		ExpensesCategoryNewEditFragment expensesCategoryNewEditFragment =
				ExpensesCategoryNewEditFragment.newInstance("edit", categoryJson);
	...
	public void onItemMove(int fromPosition, int toPosition) {
		...
		new CategoryDAO(db).updateExpensesOrderNum(categoryList.get(fromPosition),
				categoryList.get(toPosition));
	...
	public void onItemDismiss(int position) {
		...
		Toast.makeText(mContext, mContext.getString(R.string.msg_category_deleted, categoryList.get(position).getName()),
				Toast.LENGTH_SHORT).show();
