...
public class BudgetEditFragment extends Fragment {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		getActivity().setTitle(ogl4jo3.shaowei.ogl4jo3.accounting.R.string.title_budget_edit);
		// Inflate the layout for this fragment
		View view = inflater.inflate(ogl4jo3.shaowei.ogl4jo3.accounting.R.layout.fragment_budget_edit, container, false);
		initUI(view);
		setViewData();
		setOnClickListener();
	...
	private void initUI(View view) {
		etBudget = (EditText) view.findViewById(ogl4jo3.shaowei.ogl4jo3.accounting.R.id.et_budget);
		seekBarBudgetNotice = (SeekBar) view.findViewById(ogl4jo3.shaowei.ogl4jo3.accounting.R.id.seekBarBudgetNotice);
		tvNoticeMsg = (TextView) view.findViewById(ogl4jo3.shaowei.ogl4jo3.accounting.R.id.tv_budget_notice_msg);
	...
	private void setViewData() {
		...
		tvNoticeMsg.setText(
				getString(ogl4jo3.shaowei.ogl4jo3.accounting.R.string.tv_budget_notice_msg, seekBarBudgetNotice.getProgress()));
	...
	private void setOnClickListener() {
		seekBarBudgetNotice.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener() {
			...
			public void onProgressChanged(SeekBar seekBar, int progress, boolean b) {
				...
				progress = progress / 5;
				progress = progress * 5;
				tvNoticeMsg.setText(getString(ogl4jo3.shaowei.ogl4jo3.accounting.R.string.tv_budget_notice_msg, progress));
			}
