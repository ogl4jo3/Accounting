package ogl4jo3.shaowei.ogl4jo3.accounting.setting.categorymanagement;
...
public class CategoryDAO {
	...
	public static void initExpensesData(Context context, SQLiteDatabase database) {
		...
		String[] initName = {context.getString(ogl4jo3.shaowei.ogl4jo3.accounting.R.string.category_lunch),
				context.getString(ogl4jo3.shaowei.ogl4jo3.accounting.R.string.category_dinner),
				context.getString(ogl4jo3.shaowei.ogl4jo3.accounting.R.string.category_afternoon_tea),
				context.getString(ogl4jo3.shaowei.ogl4jo3.accounting.R.string.category_dessert),
				context.getString(ogl4jo3.shaowei.ogl4jo3.accounting.R.string.category_fitness),
				context.getString(ogl4jo3.shaowei.ogl4jo3.accounting.R.string.category_house),
				context.getString(ogl4jo3.shaowei.ogl4jo3.accounting.R.string.category_house_1),
				context.getString(ogl4jo3.shaowei.ogl4jo3.accounting.R.string.category_gift),
				context.getString(ogl4jo3.shaowei.ogl4jo3.accounting.R.string.category_medical),
				context.getString(ogl4jo3.shaowei.ogl4jo3.accounting.R.string.category_parenting),
				context.getString(ogl4jo3.shaowei.ogl4jo3.accounting.R.string.category_pet),
				context.getString(ogl4jo3.shaowei.ogl4jo3.accounting.R.string.category_phone),
				context.getString(ogl4jo3.shaowei.ogl4jo3.accounting.R.string.category_refueling),
				context.getString(ogl4jo3.shaowei.ogl4jo3.accounting.R.string.category_swim),
				context.getString(ogl4jo3.shaowei.ogl4jo3.accounting.R.string.category_traffic),
				context.getString(ogl4jo3.shaowei.ogl4jo3.accounting.R.string.category_video_game),
				context.getString(ogl4jo3.shaowei.ogl4jo3.accounting.R.string.category_other)};
		int[] initIcon = {
				ogl4jo3.shaowei.ogl4jo3.accounting.R.drawable.ic_category_lunch, ogl4jo3.shaowei.ogl4jo3.accounting.R.drawable.ic_category_dinner,
				ogl4jo3.shaowei.ogl4jo3.accounting.R.drawable.ic_category_afternoon_tea, ogl4jo3.shaowei.ogl4jo3.accounting.R.drawable.ic_category_dessert,
				ogl4jo3.shaowei.ogl4jo3.accounting.R.drawable.ic_category_fitness, ogl4jo3.shaowei.ogl4jo3.accounting.R.drawable.ic_category_house,
				ogl4jo3.shaowei.ogl4jo3.accounting.R.drawable.ic_category_house_1, ogl4jo3.shaowei.ogl4jo3.accounting.R.drawable.ic_category_gift,
				ogl4jo3.shaowei.ogl4jo3.accounting.R.drawable.ic_category_medical, ogl4jo3.shaowei.ogl4jo3.accounting.R.drawable.ic_category_parenting,
				ogl4jo3.shaowei.ogl4jo3.accounting.R.drawable.ic_category_pet, ogl4jo3.shaowei.ogl4jo3.accounting.R.drawable.ic_category_phone,
				ogl4jo3.shaowei.ogl4jo3.accounting.R.drawable.ic_category_refueling, ogl4jo3.shaowei.ogl4jo3.accounting.R.drawable.ic_category_swim,
				ogl4jo3.shaowei.ogl4jo3.accounting.R.drawable.ic_category_traffic, ogl4jo3.shaowei.ogl4jo3.accounting.R.drawable.ic_category_video_game,
				ogl4jo3.shaowei.ogl4jo3.accounting.R.drawable.ic_category_other};
	...
	public static void initIncomeData(Context context, SQLiteDatabase database) {
		String insertInto = "insert into " + INCOME_CATEGORY_TABLE_NAME + "(" + NAME_COLUMN + "," +
				ICON_COLUMN + "," + ORDER_NUM_COLUMN + ") ";
		String[] initName = {context.getString(ogl4jo3.shaowei.ogl4jo3.accounting.R.string.category_salary),
				context.getString(ogl4jo3.shaowei.ogl4jo3.accounting.R.string.category_bonus),
				context.getString(ogl4jo3.shaowei.ogl4jo3.accounting.R.string.category_investment),
				context.getString(ogl4jo3.shaowei.ogl4jo3.accounting.R.string.category_subsidy),
				context.getString(ogl4jo3.shaowei.ogl4jo3.accounting.R.string.category_other)};
		int[] initIcon = {
				ogl4jo3.shaowei.ogl4jo3.accounting.R.drawable.ic_category_salary, ogl4jo3.shaowei.ogl4jo3.accounting.R.drawable.ic_category_bonus,
				ogl4jo3.shaowei.ogl4jo3.accounting.R.drawable.ic_category_investment, ogl4jo3.shaowei.ogl4jo3.accounting.R.drawable.ic_category_subsidy,
				ogl4jo3.shaowei.ogl4jo3.accounting.R.drawable.ic_category_other};
		for (int i = 0; i < initName.length; i++) {
			database.execSQL(
					insertInto + " values('" + initName[i] + "','" + initIcon[i] + "','" + i +
