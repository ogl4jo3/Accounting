...
public class ExpensesAdapter extends RecyclerView.Adapter<ExpensesAdapter.ViewHolder> {
	...
	public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
		...
		View view = LayoutInflater.from(parent.getContext())
				.inflate(ogl4jo3.shaowei.ogl4jo3.accounting.R.layout.item_expenses_income, parent, false);
		...
		holder.itemView.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View view) {
				...
				fragmentManager.beginTransaction()
						.replace(ogl4jo3.shaowei.ogl4jo3.accounting.R.id.layout_main_content, expensesNewEditFragment, null)
	...
	static class ViewHolder extends RecyclerView.ViewHolder {
		...
		public ViewHolder(View itemView) {
			super(itemView);
			ivCategoryIcon = (ImageView) itemView.findViewById(ogl4jo3.shaowei.ogl4jo3.accounting.R.id.iv_category_icon);
			tvCategoryName = (TextView) itemView.findViewById(ogl4jo3.shaowei.ogl4jo3.accounting.R.id.tv_category_name);
			tvMoney = (TextView) itemView.findViewById(ogl4jo3.shaowei.ogl4jo3.accounting.R.id.tv_money);
		}
	}
}