package ogl4jo3.shaowei.ogl4jo3.utility.dialog;
...
public class StatisticsDialogFragment extends DialogFragment {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		View view = inflater.inflate(ogl4jo3.shaowei.ogl4jo3.accounting.R.layout.dialog_statistics, container, false);
		...
		lvStatistics = (ListView) view.findViewById(ogl4jo3.shaowei.ogl4jo3.accounting.R.id.lv_statistics);
		statisticsAdapter =
				new SimpleAdapter(getActivity(), mapData, ogl4jo3.shaowei.ogl4jo3.accounting.R.layout.item_statistics_record,
						new String[]{mapDateKey, mapPriceKey},
						new int[]{
								ogl4jo3.shaowei.ogl4jo3.accounting.R.id.tv_date, ogl4jo3.shaowei.ogl4jo3.accounting.R.id.tv_price});
