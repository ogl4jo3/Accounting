...
public class AccountDAO {
	...
	private Account getAccount(Cursor cursor) {
		...
		result.setStartingAmount(cursor.getInt(2));
		result.setCategory(cursor.getInt(3));
		result.setDefaultAccount(cursor.getInt(4) == 1);
		result.setBudgetPrice(cursor.getInt(5));
		result.setBudgetNotice(cursor.getInt(6));
