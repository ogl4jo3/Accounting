...
public class CategoryDAO {
	...
	public static void initExpensesData(Context context, SQLiteDatabase database) {
		...
		String[] initName = {context.getString(R.string.category_afternoon_tea),
				context.getString(R.string.category_dinner),
				context.getString(R.string.category_fitness),
				context.getString(R.string.category_house),
				context.getString(R.string.category_house_1),
				context.getString(R.string.category_lunch),
				context.getString(R.string.category_medical),
				context.getString(R.string.category_other),
				context.getString(R.string.category_parenting),
				context.getString(R.string.category_pet),
				context.getString(R.string.category_phone),
				context.getString(R.string.category_refueling),
				context.getString(R.string.category_swim),
				context.getString(R.string.category_traffic),
				context.getString(R.string.category_video_game)};
		int[] initIcon = {R.drawable.ic_category_afternoon_tea, R.drawable.ic_category_dinner,
				R.drawable.ic_category_fitness, R.drawable.ic_category_house,
				R.drawable.ic_category_house_1, R.drawable.ic_category_lunch,
				R.drawable.ic_category_medical, R.drawable.ic_category_other,
				R.drawable.ic_category_parenting, R.drawable.ic_category_pet,
				R.drawable.ic_category_phone, R.drawable.ic_category_refueling,
				R.drawable.ic_category_swim, R.drawable.ic_category_traffic,
	...
	public static void initIncomeData(Context context, SQLiteDatabase database) {
		String insertInto = "insert into " + INCOME_CATEGORY_TABLE_NAME + "(" + NAME_COLUMN + "," +
				ICON_COLUMN + "," + ORDER_NUM_COLUMN + ") ";
		String[] initName = {context.getString(R.string.category_swim),
				context.getString(R.string.category_traffic),
				context.getString(R.string.category_video_game)};
		int[] initIcon = {R.drawable.ic_category_swim, R.drawable.ic_category_traffic,
				R.drawable.ic_category_video_game};
		for (int i = 0; i < initName.length; i++) {
			database.execSQL(
					insertInto + " values('" + initName[i] + "','" + initIcon[i] + "','" + i +
