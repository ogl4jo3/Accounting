...
public class IncomeFragment extends Fragment {
	...
	private void setViewData() {
		tvDate.setText(dateStr);
		tvThisDayIncome.setText(NumberFormat.getNumberInstance(Locale.getDefault())
				.format(calculateThisDayIncome()));
		tvThisMonthIncome
				.setText(NumberFormat.getNumberInstance(Locale.getDefault()).format(3563464));
		tvIncomePercent.setText(getResources().getString(R.string.tv_income_percent, 95));
	}
