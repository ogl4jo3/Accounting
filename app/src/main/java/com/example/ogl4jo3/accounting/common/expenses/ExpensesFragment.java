...
public class ExpensesFragment extends Fragment {
	...
	private void setViewData() {
		tvDate.setText(dateStr);
		tvThisDayExpenses.setText(NumberFormat.getNumberInstance(Locale.getDefault())
				.format(calculateThisDayExpenses()));
		tvRemainingBudget
				.setText(NumberFormat.getNumberInstance(Locale.getDefault()).format(3563464));
		tvTotalBudget.setText(NumberFormat.getNumberInstance(Locale.getDefault()).format(3563464));
		tvBudgetPercent.setText(getResources().getString(R.string.tv_budget_percent, 95));
	}
