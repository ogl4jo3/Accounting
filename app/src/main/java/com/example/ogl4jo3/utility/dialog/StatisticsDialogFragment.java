package com.example.ogl4jo3.utility.dialog;
...
import com.example.ogl4jo3.accounting.common.expenses.Expenses;
import com.example.ogl4jo3.accounting.common.expenses.ExpensesDAO;
import com.example.ogl4jo3.accounting.common.income.Income;
...
public class StatisticsDialogFragment extends DialogFragment {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if (expenses_income.equalsIgnoreCase(EXPENSES)) {
			...
			for (int i = 0; i < expensesLen; i++) {
				...
				data.put(mapPriceKey, "$" + expensesList.get(i).getPrice());
				mapData.add(data);
			}
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		statisticsAdapter =
				new SimpleAdapter(getActivity(), mapData, R.layout.item_statistics_record,
						new String[]{mapDateKey, mapPriceKey},
						new int[]{R.id.tv_date, R.id.tv_price});
